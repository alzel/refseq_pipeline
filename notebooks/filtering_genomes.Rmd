...
```{r}
assembly_summary %>% filter(annotation_provider %in% c("NCBI RefSeq", "DOE Joint Genome Institute", "Broad Institute", "Aalborg University", "JGI", "Cornell University", "Uppsala University" ), group == "fungi") %>% 
